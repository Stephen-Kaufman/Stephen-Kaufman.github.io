...
_.first = function(array, number) {
    ...
    if (array.length > number > 0) return array.slice(0, number);
...
_.filter = function(array, filterFunc) {
    ...
    for (var i = 0; i < array.length; i++) {
        if (filterFunc(array[i], i, array) === true) {
...
*/
_.reject = function(array, rejFunc) {
    return _.filter(array, function(element, index, array) {
        return !rejFunc(element, index, array);
...
*/
_.partition = function (array, partFunc) {
    return [_.filter(array, partFunc), _.reject(array, partFunc)];
};
...
_.map = function(collection, mapFunc) {
    ...
    _.each(collection, function(element, i, collection) {
        newArray.push(mapFunc(element, i, collection));
    });
    return newArray;
};
...
*/
_.pluck = function (arrOfObj, property) {
...
_.some = function(collection, someFunc) {
    var watchOut = false;
    if(someFunc === undefined) {
        someFunc = _.identity;
    }
        _.each(collection, function(element, index, collection) {
            if (someFunc(element, index, collection) === true) {
                return watchOut = true;
            }
        });
        return watchOut;
};
...
*/
_.reduce = function(array, redFunc, seed) {
    var preRes = seed;
    ...
    _.each(array, function(element, index, collection) {
        ...
        preRes = redFunc(preRes, element, index);
    });
    return preRes;
};
